...
# Only Italy
inscrIT_json <- jsonlite::fromJSON("https://sciencedata.dk/public/b6b6afdb969d378b70929e86e58ad975/EDH_subset_2021-02-15.json")
...
# Cost of covering the distance
insc_4326$Lcp_dist_1ktown <- costDistance(conductance,
             fromCoords= as(insc_4326, "Spatial"), 
             toCoords=as(nearestcitycoords, "Spatial"))
